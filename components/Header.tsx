...
const FALLBACK_CATEGORIES = [
  ...
  { id: "gym-collection", name: "Gym Collection" },
  { id: "streetwear-collection", name: "Streetwear Collection" },
...
export default function Header() {
  ...
  const [navCategories, setNavCategories] = useState<any[]>(FALLBACK_CATEGORIES);
    ...
    <>
      ...
      >
        <div className="relative max-w-wrap mx-auto px-4 md:px-7 flex items-center justify-between h-[64px] md:h-[74px]">
          ...
          <Link href="/" className="hidden lg:flex items-center gap-2 shrink-0 overflow-hidden" aria-label="RAWFLEX Home" style={{ height: '100%' }}>
            <Image
              src="/rawflex_logo.png"
              alt="RAWFLEX Logo"
              width={96}
          ...
          <div className="hidden lg:flex items-center gap-5">
            ...
            {user ? (
              ...
              <Link href="/login" title="Login / Register" className="text-ink hover:text-gold transition-colors">
                <User className="w-[19px] h-[19px]" />
              </Link>
            )}
